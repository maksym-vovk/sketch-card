(function () {
    ...
    function updateSlides() {
      ...
      swiper.virtualSize = -spaceBetween - offsetBefore - offsetAfter; // reset margins
      ...
      if (!params.centeredSlides) {
        ...
        const shouldSnapToSlideEdge = params.snapToSlideEdge && !params.loop && (params.slidesPerView === 'auto' || isFractionalSlidesPerView); // Calculate the last allowed snap index when snapToSlideEdge is enabled
    ...
    function loopFix({
      ...
      const activeColIndexWithShift = activeColIndex + (bothDirections && typeof setTranslate === 'undefined' ? -slidesPerView / 2 + 0.5 : 0); // prepend last slides before start
    ...
    function setBreakpoint() {
      ...
      const document = getDocument(); // Get breakpoint for window/container width and update parameters
