      ...
      function postDate() {
        ...
        for (let counter = 0; counter < counterLength; counter++) {
          ...
          for (let i = 0; i < nodeList.length; i++) {
            ...
            data.format ? nodeList[i].innerHTML = format(date, data.format) // format: особливий формать для окремої дати. Додаєм як data-format="фомарт". Формати дивитись в switch'і нижче. dd - цифри, day - прописом.
        ...
        function time(nodeList, reverse) {
          ...
          for (let i = 0; i < nodeList.length; i++) nodeList[i].className.match(/\btime\b/) ? timeArray.push(timeRandom()) : false;
    ...
    var scrollSmooth = (() => {
      ...
      for (var i = 0; i < linkNav.length; i++) {
        linkNav[i].addEventListener('click', function (e) {
          ...
          var t = target.getBoundingClientRect().top - 20,
